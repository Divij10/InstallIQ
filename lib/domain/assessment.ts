...
export type EvStation = { id: number; name: string; address?: string; network?: string; distanceMiles?: number; status?: string; access?: string; dcFastPorts?: number; level2Ports?: number; connectorTypes?: string[]; lastConfirmed?: string };
