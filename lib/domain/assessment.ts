...
export const assessmentRequestSchema = z.object({
  requestId: z.string().trim().max(80).optional(), businessName: clean(120),
...
export type SiteContextResult = { timeZone?: string; unavailable?: boolean };
