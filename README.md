...
See [the full documentation](docs/DOCUMENTATION.md) for the implementation details, the Precisely resource rationale, how the hosted Data Integrity Suite gateway exposes the Precisely APIs, the best practices the integration follows, live setup, and what this prototype deliberately does not do.
