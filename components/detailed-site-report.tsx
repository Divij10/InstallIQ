...
export function DetailedSiteReport({ result }: { result: AssessmentResult }) {
  ...
  return <>
    <section className="site-record" aria-label="Site record">
      <div className="report-section-heading"><div className="eyebrow">SITE RECORD</div><h3>Site record</h3></div>
    ...
    <section className="nearby-charging" aria-label="Nearby public charging">
